...
if __name__ == '__main__':
    ...
    while True: 
        ...
        if bikeCounter >= 120 and carCounter >= 120 and busCounter >= 8:
            break

        randomChoice = random.choice(vehicles)
        choiceVehicle = randomChoice
        if choiceVehicle == "bike" and bikeCounter <= 120:
            bikeCounter += 1
            bObject = Bike(5, 2, "bike")
            bObjectArea = bObject.getArea()
            tempBikeArea = bObjectArea
            #print(bObjectArea)
            bOjectName = bikeCounter
        ...
        elif choiceVehicle == "car" and carCounter <= 120:
            carCounter += 1
            cObject = Car(5,4, "car")
            cObjectArea = cObject.getArea()
            tempCarArea = cObjectArea
            cOjectName = carCounter
        ...
        elif choiceVehicle == "bus" and busCounter <= 8:
            busCounter += 1
            busObject = Bus(10,5,"bus")
            busObjectArea = busObject.getArea()
            tempBusArea = busObjectArea
            busOjectName = busCounter
